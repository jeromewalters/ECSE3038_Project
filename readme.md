...
{ "user_temp": 30,	"temp_duration": 10, "user_light": "sunset", "light_duration": "4h" }
...
*fig 4.1:* This function can be used to parse the `light_duration` field in the client request shown in [*fig 1.1*](https://www.notion.so/Simple-Smart-Hub-e7ebc70d3b23473bb20ca6e60eda9cbe) and [*fig 1.2*](https://www.notion.so/Lect-2-d33e53fd5e654c0b907afc6114cd1aae)
